      ...
      <div className="max-w-[980px] mx-auto h-full flex items-center justify-between px-2">
        ...
        <nav className="flex items-center gap-1">
          ...
          <button className={`${navLinkClass} relative flex items-center gap-1`}>
            Mensajes
            <span className="bg-[#cc0000] text-white text-[9px] font-bold px-1 rounded-sm shadow-sm">1</span>
          </button>

          <div className="w-[1px] h-4 bg-[#4d86b5] mx-2"></div>

          <button className="flex items-center gap-1 text-white text-[11px] font-bold hover:bg-[#004a8c] px-2 py-1 rounded-[4px]">
            Mi cuenta
            <ChevronDown size={10} />
          </button>
        </nav>
