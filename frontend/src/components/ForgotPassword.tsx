    ...
    return (
        <div className="min-h-screen flex flex-col font-sans bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900 relative overflow-hidden">
                    ...
                    <div className="p-8">
                        {!isSent ? (
                            <>
                                ...
                                {error && (
                                    <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl mb-6 text-xs animate-in slide-in-from-top-1">
                                        {error}
                                    </div>
                                )}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-2 bg-[var(--input-bg)] text-[var(--input-text)] border border-[var(--border-color)] rounded-xl text-sm outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-transparent transition-all"
                                                placeholder="ejemplo@fourtty.com"
                                                required
                                            />
                                        </div>
                                    </div>
                            ...
                            <div className="text-center py-4 animate-in fade-in slide-in-from-bottom-2">
                                ...
                                <div className="bg-blue-50 p-4 rounded-xl text-xs text-blue-800 text-left mb-8 border border-blue-100">
            ...
            <div className="p-4 text-center text-white/60 text-[10px]">
                © Fourtty 2026 • Todos los derechos reservados
            </div>
        </div>
    );
};
